...
<div class={`dark:bg-slate-800 bg-slate-300 hover:bg-gradient-to-br ${colours[social.name]} hover:scale-110 hover:shadow-2xl duration-100 rounded-lg p-8 mx-4 my-2 sm:my-0`}>
